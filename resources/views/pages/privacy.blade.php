...
<header class="py-10">
  <div class="max-w-screen-sm md:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-bold text-white">🔒 Privacy Policy for AxieAndFriends.com</h1>
    <h1 class="text-gray-50 text-2xl font-bold mt-7">Privacy Policy</h1>
...
<main class="-mt-32">
  <div class="max-w-screen-sm md:max-w-screen-2xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-12 bg-gray-100 text-gray-800 border border-gray-500 rounded-lg shadow px-5 py-6 sm:px-6 space-y-7">
      ...
      <h1 class="text-2xl font-medium">Collecting and Using Your Personal Data</h1>
      ...
      <h2 class="text-lg font-medium">Use of Your Personal Data</h2>
      ...
      <h2 class="text-lg font-medium">Retention of Your Personal Data</h2>
      ...
      <h2 class="text-lg font-medium">Transfer of Your Personal Data</h2>
      ...
      <h2 class="text-lg font-medium">Disclosure of Your Personal Data</h2>
      ...
      <h2 class="text-lg font-medium">Security of Your Personal Data</h2>
      <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
      <h1 class="text-2xl font-medium">Children's Privacy</h1>
      ...
      <h1 class="text-2xl font-medium">Changes to this Privacy Policy</h1>
      ...
      <h1 class="text-3xl font-medium">Cookies Policy</h1>
      ...
      <ul>
        <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to AxieAndFriends.com.</li>
      ...
      <h1 class="text-2xl font-medium">The use of the Cookies</h1>
      <h2 class="text-lg font-medium">Type of Cookies We Use</h2>
      ...
      <h2 class="text-lg font-medium">Your Choices Regarding Cookies</h2>
      ...
      <h2 class="text-lg font-medium">More Information about Cookies</h2>
